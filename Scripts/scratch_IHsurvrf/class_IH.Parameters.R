...
#' @include class_IH.TimeInfo.R IH.criticalValue.R class_IH.TreeType.R
#' #' @include class_IH.TreeConditions.R class_IH.TreeType.R

source("class_IH.TimeInfo.R")
source("IH.criticalValue.R")
source("class_IH.TreeType.R")
source("class_IH.TreeConditions.R")
source("class_IH.TreeType.R")
...
.parameters <- function(
    ...
    # integer: total number of timepoints to be used (is this the same as the number of stages)
    ############## not sure if we need this
    nTimes,
